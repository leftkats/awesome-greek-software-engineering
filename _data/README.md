...
| **`cafe_resources.yaml`** | Laptop-friendly **cafés** and **directory** sites (`kind: cafe` vs `kind: directory`). Feeds **[docs/remote-cafe-resources.md](../docs/remote-cafe-resources.md)** and the Resources page. |
